          ...
          <Carousel
            ...
            prevArrow={({ handlePrev }) => (
              <IconButton
                ...
                size="lg"
                onClick={handlePrev}
                className="!absolute left-4 top-2/4 -translate-y-2/4 bg-gray-800 bg-opacity-50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            nextArrow={({ handleNext }) => (
              <IconButton
                ...
                size="lg"
                onClick={handleNext}
                className="!absolute !right-4 top-2/4 -translate-y-2/4 bg-gray-800 bg-opacity-50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
